...
import puyuntech.com.beihai.ui.activity.renwu.RenWuDeatilActivity;

/**
 * Created by hiro on 7/27/15.
 */
public abstract class RenWuAdapter extends RecyclerView.Adapter<RenWuAdapter.MyViewHolder> {

    protected List<RenWuMod> data;

    public RenWuAdapter(List l) {
        data = l;
    }
