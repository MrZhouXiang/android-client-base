...
@ContentView(R.layout.activity_shi_jian)
public class ShiJianActivity extends BaseAct {
...
//                ll_bottombar.setVisibility(View.VISIBLE);
    ...
    private void setupViewPager(ViewPager viewPager) {
            ...
            ShiJianListFragment mMoreListFragment1 = new ShiJianListFragment();
            ShiJianListFragment mMoreListFragment2 = new ShiJianListFragment();
            ...
            adapter.addFragment(mMoreListFragment1, "待办");
            adapter.addFragment(mMoreListFragment2, "历史");
